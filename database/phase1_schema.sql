...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `courier_code` VARCHAR(5) NULL DEFAULT NULL COMMENT 'Kode bisnis kurir dengan format kode cabang dan nomor urut',
  ...
  CONSTRAINT `uq_users_courier_code` UNIQUE (`courier_code`),
